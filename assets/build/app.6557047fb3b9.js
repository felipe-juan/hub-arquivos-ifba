...
function getPdfRuntime() {
  if (!pdfRuntimePromise) pdfRuntimePromise = import("./pdf-runtime.6e524f4f562a.js");
...
function loadDeferredFeatureScripts() {
  const scripts = [
    ...
    "assets/build/sidebar-quick-search.ad3450d48011.js",
    "assets/build/performance-monitor.74cab93e5187.js"
  ];
