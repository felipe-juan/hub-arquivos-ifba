...
function getPdfRuntime() {
  if (!pdfRuntimePromise) pdfRuntimePromise = import("./js/pdf-runtime.js?v=0.2.70");
...
function ensureSearchWorker() {
  ...
  searchWorkerInitPromise = new Promise((resolve, reject) => {
    const worker = new Worker("js/search-worker.js?v=0.2.70");
    searchWorker = worker;
...
async function searchInWorker(query, filters) {
  ...
  try {
    ...
    if (!window.HubSearchEngine) await import("./js/search-engine.js?v=0.2.70");
...
function loadDeferredFeatureScripts() {
  const scripts = [
    "js/enhancements.js?v=0.2.70",
    "js/experience.js?v=0.2.70",
    "js/sidebar-quick-search.js?v=0.2.70",
    "js/performance-monitor.js?v=0.2.70"
  ];
