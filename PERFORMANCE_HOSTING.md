...
A v0.2.38 mede os tamanhos bruto, gzip e Brotli dos recursos iniciais. A compactação é responsabilidade do servidor/CDN; PDF, WebP, AVIF, WASM e ZIP já são formatos comprimidos e não devem ser recomprimidos.
