const VERSION = "hub-ifba-v0.2.86";
...
const CORE = [
  ...
  "assets/build/app.59db98b4dedb.js",
  ...
  "./apps/catalog.json",
  "./apps/assistente/",
  "./apps/assistente/index.html?v=1.6.5",
  "./apps/assistente/config.js?v=1.6.5",
  "./apps/assistente/app.css?v=1.6.5",
  "./apps/assistente/app.js?v=1.6.5",
  "./apps/assistente/offline-data.json?v=1.6.5",
  "./sidebar/sidebar.css",
  "./sidebar/sidebar.js",
...
const REQUIRED_CORE = new Set([
  ...
  "assets/build/data.74bf9e83114b.js", "assets/build/app.59db98b4dedb.js", "assets/build/storage.aade70adc118.js", "assets/build/design-system.f488faad941e.js", "assets/build/where-data.2815ed20f527.js",
]);
