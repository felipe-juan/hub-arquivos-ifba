...
const CORE = [
  ...
  "assets/build/data.93b7a3501a11.js",
  "assets/build/app.cb36fc5c59e6.js",
  ...
  "./apps/catalog.json",
  "./apps/assistente/",
  "./apps/assistente/index.html?v=2.0.30",
  "./apps/assistente/config.js?v=2.0.30",
  "./apps/assistente/app.css?v=2.0.30",
  "./apps/assistente/app.js?v=2.0.30",
  "./apps/assistente/offline-data.json?v=2.0.30",
  "./apps/assistente/offline-academic.json?v=2.0.30",
  "./apps/assistente/assets/calendario-academico-2026.png?v=2.0.30",
  "./sidebar/sidebar.css",
  "./sidebar/sidebar.js",
  ...
  "apps/build/calendar-data.84ae485c16ae.js",
  "./apps/calendario/data/source-metadata.json",
  "./apps/fluxogramas/",
  "./apps/fluxogramas/index.html",
  "apps/build/fluxogramas-data.a37b87063d78.js",
  "./apps/fluxogramas/data/source-metadata.json",
  "./apps/barema/",
  "./apps/barema/index.html",
  "apps/build/barema-data.33efba1c5da4.js",
  "./apps/barema/data/source-metadata.json",
  "./apps/doom/",
  "./apps/doom/index.html",
  "apps/build/doom.62c68b1a02c4.css",
  "apps/build/doom.98841ed189c1.js",
  "./apps/doom/vendor/runtime-manifest.json",
  "./apps/doom/coi-serviceworker.js",
];
...
const REQUIRED_CORE = new Set([
  ...
  "assets/build/data.93b7a3501a11.js", "assets/build/app.cb36fc5c59e6.js", "assets/build/storage.aade70adc118.js", "assets/build/design-system.f488faad941e.js", "assets/build/where-data.2815ed20f527.js",
]);
