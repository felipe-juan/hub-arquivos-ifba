...
const CORE = [
  ...
  "./apps/catalog.json",
  "./apps/assistente/",
  "./apps/assistente/index.html?v=2.0.16",
  "./apps/assistente/config.js?v=2.0.16",
  "./apps/assistente/app.css?v=2.0.16",
  "./apps/assistente/app.js?v=2.0.16",
  "./apps/assistente/offline-data.json?v=2.0.16",
  "./apps/assistente/offline-academic.json?v=2.0.16",
  "./apps/assistente/assets/calendario-academico-2026.png?v=2.0.16",
  "./sidebar/sidebar.css",
  "./sidebar/sidebar.js",
